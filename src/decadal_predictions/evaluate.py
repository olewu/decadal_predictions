...
def evaluation(vf,fc,var,score_names=['ACC','RMSE','STD'],tdim='year',ensmem_dim='mem',vf_coord_map={'latitude':'lat','longitude':'lon'}):

    fcem_da = fc.mean(ensmem_dim)[var_name_map['long_to_cmip'][var]]
